import 'package:ardear_bakery/src/models/mercado_pago_credit_cart.dart';
import 'package:ardear_bakery/src/models/mercado_pago_customer.dart';
import 'package:ardear_bakery/src/models/mercado_pago_tax.dart';
import 'package:ardear_bakery/src/models/mercado_pago_transaction_detail.dart';
...
class MercadoPagoPayment{
  ...
  MercadoPagoPayment({this.id, this.status, this.transactionDetails, this.callBackUrl});
  ...
  MercadoPagoPayment.fromJsonMap( Map<String, dynamic> json ) {
    id                        = json['id'].toString();
    dateApproved              = json['date_approved'] is String ? DateTime.parse(json['date_approved']) : json['date_approved'];
    dateLastUpdated           = json['date_last_updated'] is String ? DateTime.parse(json['date_last_updated']) : json['date_last_updated'];
    dateOfExpiration          = json['date_of_expiration'] is String ? DateTime.parse(json['date_of_expiration']) : json['date_of_expiration'];
    moneyReleaseDate          = json['money_release_date'] is String ? DateTime.parse(json['money_release_date']) : json['money_release_date'];
    ...
    taxesAmount               = (json['taxes_amount'] != null) ? double.parse(json['taxes_amount'].toString()) : 0;
    counterCurrency           = json['counter_currency'];
    shippingAmount            = (json['shipping_amount'] != null) ? double.parse(json['shipping_amount'].toString()) : 0;
    posId                     = json['pos_id'];
    ...
    payer                     = json['payer'] is MercadoPagoCustomer ? json['payer'] : MercadoPagoCustomer.fromJsonMap(json['payer'] ?? {});
    ...
    transactionDetails        = json['transaction_details'] is MercadoPagoTransactionDetail ? json['transaction_details'] : MercadoPagoTransactionDetail.fromJsonMap(json['transaction_details'] ?? {}) ;
    feeDetails                = json['fee_details'];
    captured                  = json['captured'];
    binaryMode                = json['binary_mode'];
    callForAuthorizeId        = json['call_for_authorized_id'];
    statementDescriptor       = json['statement_descriptor'];
    installments              = (json['installments'] != null) ? int.parse(json['installments'].toString()) : 0;
    card                      = json['card'] is MercadoPagoCreditCard ? json['card'] : MercadoPagoCreditCard.fromJsonMap(json['card'] ?? {});
