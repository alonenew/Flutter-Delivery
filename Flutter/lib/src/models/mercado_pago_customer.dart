...
class MercadoPagoCustomer {
  ...
  MercadoPagoCustomer.fromJsonMap( Map<String, dynamic> json ) {
    ...
    identificationType       = (json['identification'] != null) ? json['identification']['type'] : null;
    identificationNumber     = (json['identification'] != null) ? json['identification']['number'] : null;
    addressId                = (json['address'] != null) ? json['address']['id'] : null;
    addressZip               = (json['address'] != null) ? json['address']['zip_code'] : null;
    addressStreetName        = (json['address'] != null) ? json['address']['street_name'] : null;
    addressStreetNumber      = (json['address'] != null) ? json['address']['street_number'] : null;
    dateRegistered           = (json['date_registered'] != null) ? DateTime.parse(json['date_registered']) : null;
    description              = json['description'];
    dateCreated              = (json['date_created'] != null) ? DateTime.parse(json['date_created']) : null;
    dateLastUpdated          = (json['date_last_updated'] != null) ? DateTime.parse(json['date_last_updated']) : null;
