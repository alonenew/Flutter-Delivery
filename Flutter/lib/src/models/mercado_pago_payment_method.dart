import 'package:ardear_bakery/src/models/mercado_pago_financial_institution.dart';
...
class MercadoPagoPaymentMethod {
  ...
  MercadoPagoPaymentMethod.fromJsonMap( Map<String, dynamic> json ) {
    ...
    financialInstitutions   = (json['financial_institutions'] != null) ? MercadoPagoFinancialInstitution.fromJsonList(json['financial_institutions']).institutionList : [];
  }
